...
public class ContractRpcTests
{
    ...
    //[Fact]
    //internal void ExecuteAction_Read_ExpectedJsonResponse()
    //{
    ...
    //    var result = contractRpc.ExecuteAction(mockRpcAction.Object, request);
    ...
    //[Fact]
    //internal void ExecuteAction_Write_ExpectedTransactionHash()
    //{
    //    const string transactionHash = "transactionHash";
    //    MockRpcActionExecute(MockTransactionInput.MockTx, transactionHash);

    //    var result = contractRpc.ExecuteAction(mockRpcAction.Object, MockTransactionInput.MockTx);
