...
{
    [Theory]
    [InlineData(0, "0xE433FfB237950BddCd4a2CD86515B43cea1fDCC8")]
    [InlineData(1, "0xD31e497678B4269EE553A819C505D4a78d0CBF6A")]
    internal void GetWallet_ExpectedAddress(int id, string address)
    {
